...
namespace DNI.Core.Shared.Contracts.Services
{
    ...
    public interface ICacheService
    {
        ...
        /// <summary>
        /// Method to retrieve a value of <see cref="T"/> from the caching store
        /// </summary>
        /// <typeparam name="T">The <see cref="T"/> value to be returned</typeparam>
        /// <param name="cacheKeyName">The key of the item stored</param>
        /// <param name="serializer">The <see cref="SerializerType"/> that should be used to convert the byte representation to <see cref="T"/></param>
        ...
        /// 
        /// </summary>
        /// <typeparam name="T">The <see cref="T"/> value to be stored</typeparam>
